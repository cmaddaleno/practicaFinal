...
module.controller('editAutoController', function ($scope, $log, $routeParams, $location, autoResource) {
    ...
    $scope.get = function(){
        ...
        autoResource.query({id:$routeParams.id}, successCallback, errorCallback);
    };
